...
function Hero(): React.ReactElement {
  ...
  const startUploadPushEndpoint: string = isLogin ? "/dashboard" : "/auth/login"
  ...
  return (
    <section className="relative top-[4rem] h-full w-full pb-10 @container">
      <main className="flex flex-col items-center justify-center gap-5 pt-[4rem] @xl:pt-[4.5rem]">
        ...
        >
          Immerse yourself in a world where creativity knows no bounds. Explore
        ...
        <div className="relative">
          <LazyLoadImage
            ...
            alt="test"
            src={dummyImageSrc}
            className="relative top-2 rounded-lg border object-fill @lg:scale-[0.9] sm:top-0"
          />
        </div>
      </main>
    </section>

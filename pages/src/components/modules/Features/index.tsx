...
function Features(): React.ReactElement {
  return (
    <section className="light:bg-primary-foreground/100 relative top-[6.2rem] h-full w-full border-b border-t pb-10 @container @3xl:top-[4.5rem] dark:bg-primary-foreground/20">

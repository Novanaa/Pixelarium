...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/asus/Desktop/new pixelarium/apps/server/v1/packages/prisma/generated/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
path.join(process.cwd(), "packages/prisma/generated/client/libquery_engine-debian-openssl-1.1.x.so.node")
// file annotations for bundling tools to include these files
